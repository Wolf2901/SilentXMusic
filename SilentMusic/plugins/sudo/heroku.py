...
from SilentMusic.misc import HAPP, SUDOERS, XCB
from SilentMusic.utils.database import (get_active_chats,
                                       remove_active_chat,
