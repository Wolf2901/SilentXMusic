from SilentMusic.plugins.techzbots.database.limitsdb import is_approved
import random
import string
...
from SilentMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from SilentMusic.core.call import Silent
from SilentMusic.utils import seconds_to_min, time_to_seconds
from SilentMusic.utils.channelplay import get_channeplayCB
from SilentMusic.utils.database import is_video_allowed
from SilentMusic.utils.decorators.language import languageCB
from SilentMusic.utils.decorators.play import PlayWrapper
from SilentMusic.utils.formatters import formats
from SilentMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from SilentMusic.utils.inline.playlist import botplaylist_markup
from SilentMusic.utils.logger import play_logs
from SilentMusic.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("SilentPlaylists") & ~BANNED_USERS
)
@languageCB
