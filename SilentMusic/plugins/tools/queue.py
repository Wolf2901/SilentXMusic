...
from SilentMusic.utils import (Silentbin, get_channeplayCB,
                              seconds_to_min)
from SilentMusic.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from SilentMusic.utils.decorators.language import language, languageCB
from SilentMusic.utils.inline import queue_back_markup, queue_markup
