...
from SilentMusic.utils.database import get_authuser_names, get_cmode
from SilentMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from SilentMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Silent.stop_stream(message.chat.id)
    except:
        pass
